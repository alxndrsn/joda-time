...
/**
 * This class is a Junit unit test for BikramSambatChronology.
 *
 * @author TODO
 */
public class TestBikramSambatChronology extends TestCase {

    // TODO all tests have been copied over from EthiopicChronology.  They need
    // replacing with tests for similar concepts for BikramSambatChronology.
    ...
    private static final Chronology BIKRAM_UTC = BikramSambatChronology.getInstanceUTC();
    ...
    public TestBikramSambatChronology(String name) {
        super(name);
    }
    ...
    public void testFactoryUTC() {
        assertEquals(DateTimeZone.UTC, BikramSambatChronology.getInstanceUTC().getZone());
        assertSame(BikramSambatChronology.class, BikramSambatChronology.getInstanceUTC().getClass());
    }

    public void testFactory() {
        assertEquals(LONDON, BikramSambatChronology.getInstance().getZone());
        assertSame(BikramSambatChronology.class, BikramSambatChronology.getInstance().getClass());
    }

    public void testFactory_Zone() {
        assertEquals(TOKYO, BikramSambatChronology.getInstance(TOKYO).getZone());
        assertEquals(PARIS, BikramSambatChronology.getInstance(PARIS).getZone());
        assertEquals(LONDON, BikramSambatChronology.getInstance(null).getZone());
        assertSame(BikramSambatChronology.class, BikramSambatChronology.getInstance(TOKYO).getClass());
    }

    //-----------------------------------------------------------------------
    public void testEquality() {
        assertSame(BikramSambatChronology.getInstance(TOKYO), BikramSambatChronology.getInstance(TOKYO));
        assertSame(BikramSambatChronology.getInstance(LONDON), BikramSambatChronology.getInstance(LONDON));
        assertSame(BikramSambatChronology.getInstance(PARIS), BikramSambatChronology.getInstance(PARIS));
        assertSame(BikramSambatChronology.getInstanceUTC(), BikramSambatChronology.getInstanceUTC());
        assertSame(BikramSambatChronology.getInstance(), BikramSambatChronology.getInstance(LONDON));
    }

    public void testWithUTC() {
        assertSame(BikramSambatChronology.getInstanceUTC(), BikramSambatChronology.getInstance(LONDON).withUTC());
        assertSame(BikramSambatChronology.getInstanceUTC(), BikramSambatChronology.getInstance(TOKYO).withUTC());
        assertSame(BikramSambatChronology.getInstanceUTC(), BikramSambatChronology.getInstanceUTC().withUTC());
        assertSame(BikramSambatChronology.getInstanceUTC(), BikramSambatChronology.getInstance().withUTC());
    }

    public void testWithZone() {
        assertSame(BikramSambatChronology.getInstance(TOKYO), BikramSambatChronology.getInstance(TOKYO).withZone(TOKYO));
        assertSame(BikramSambatChronology.getInstance(LONDON), BikramSambatChronology.getInstance(TOKYO).withZone(LONDON));
        assertSame(BikramSambatChronology.getInstance(PARIS), BikramSambatChronology.getInstance(TOKYO).withZone(PARIS));
        assertSame(BikramSambatChronology.getInstance(LONDON), BikramSambatChronology.getInstance(TOKYO).withZone(null));
        assertSame(BikramSambatChronology.getInstance(PARIS), BikramSambatChronology.getInstance().withZone(PARIS));
        assertSame(BikramSambatChronology.getInstance(PARIS), BikramSambatChronology.getInstanceUTC().withZone(PARIS));
    }

    public void testToString() {
        assertEquals("BikramSambatChronology[Europe/London]", BikramSambatChronology.getInstance(LONDON).toString());
        assertEquals("BikramSambatChronology[Asia/Tokyo]", BikramSambatChronology.getInstance(TOKYO).toString());
        assertEquals("BikramSambatChronology[Europe/London]", BikramSambatChronology.getInstance().toString());
        assertEquals("BikramSambatChronology[UTC]", BikramSambatChronology.getInstanceUTC().toString());
    }

    //-----------------------------------------------------------------------
    public void testDurationFields() {
        final BikramSambatChronology ethiopic = BikramSambatChronology.getInstance();
        ...
        final BikramSambatChronology ethiopicUTC = BikramSambatChronology.getInstanceUTC();
        ...
        final BikramSambatChronology ethiopicGMT = BikramSambatChronology.getInstance(gmt);
    ...
    public void testEpoch() {
        DateTime epoch = new DateTime(1, 1, 1, 0, 0, 0, 0, BIKRAM_UTC);
        assertEquals(new DateTime(8, 8, 29, 0, 0, 0, 0, JULIAN_UTC), epoch.withChronology(JULIAN_UTC));
    }

    public void testEra() {
        assertEquals(1, BikramSambatChronology.EE);
        try {
            new DateTime(-1, 13, 5, 0, 0, 0, 0, BIKRAM_UTC);
            fail();
    ...
    public void testCalendar() {
        ...
        DateTimeField dayOfWeek = BIKRAM_UTC.dayOfWeek();
        DateTimeField dayOfYear = BIKRAM_UTC.dayOfYear();
        DateTimeField dayOfMonth = BIKRAM_UTC.dayOfMonth();
        DateTimeField monthOfYear = BIKRAM_UTC.monthOfYear();
        DateTimeField year = BIKRAM_UTC.year();
        DateTimeField yearOfEra = BIKRAM_UTC.yearOfEra();
        DateTimeField era = BIKRAM_UTC.era();
    ...
    public void testSampleDate() {
        DateTime dt = new DateTime(2004, 6, 9, 0, 0, 0, 0, ISO_UTC).withChronology(BIKRAM_UTC);
        assertEquals(BikramSambatChronology.EE, dt.getEra());
        ...
        assertEquals(new DateTime(1997, 10, 2, 0, 0, 0, 0, BIKRAM_UTC), fld.addToCopy(1));
        ...
        assertEquals(new DateTime(1997, 1, 2, 0, 0, 0, 0, BIKRAM_UTC), fld.addToCopy(4));
        assertEquals(new DateTime(1996, 1, 2, 0, 0, 0, 0, BIKRAM_UTC), fld.addWrapFieldToCopy(4));
        ...
        assertEquals(new DateTime(1996, 10, 3, 0, 0, 0, 0, BIKRAM_UTC), fld.addToCopy(1));
    ...
    public void testSampleDateWithZone() {
        DateTime dt = new DateTime(2004, 6, 9, 12, 0, 0, 0, PARIS).withChronology(BIKRAM_UTC);
        assertEquals(BikramSambatChronology.EE, dt.getEra());
        assertEquals(1996, dt.getYear());
        assertEquals(1996, dt.getYearOfEra());
        assertEquals(10, dt.getMonthOfYear());
    ...
    public void testDurationYear() {
        ...
        DateTime dt96 = new DateTime(1996, 10, 2, 0, 0, 0, 0, BIKRAM_UTC);
        DateTime dt97 = new DateTime(1997, 10, 2, 0, 0, 0, 0, BIKRAM_UTC);
        DateTime dt98 = new DateTime(1998, 10, 2, 0, 0, 0, 0, BIKRAM_UTC);
        DateTime dt99 = new DateTime(1999, 10, 2, 0, 0, 0, 0, BIKRAM_UTC);
        DateTime dt00 = new DateTime(2000, 10, 2, 0, 0, 0, 0, BIKRAM_UTC);
        
        DurationField fld = dt96.year().getDurationField();
        assertEquals(BIKRAM_UTC.years(), fld);
    ...
    public void testDurationMonth() {
        // Leap 1999, NotLeap 1996,97,98
        DateTime dt11 = new DateTime(1999, 11, 2, 0, 0, 0, 0, BIKRAM_UTC);
        DateTime dt12 = new DateTime(1999, 12, 2, 0, 0, 0, 0, BIKRAM_UTC);
        DateTime dt13 = new DateTime(1999, 13, 2, 0, 0, 0, 0, BIKRAM_UTC);
        DateTime dt01 = new DateTime(2000, 1, 2, 0, 0, 0, 0, BIKRAM_UTC);
        
        DurationField fld = dt11.monthOfYear().getDurationField();
        assertEquals(BIKRAM_UTC.months(), fld);
    ...
    public void testLeap_5_13() {
        Chronology chrono = BikramSambatChronology.getInstance();
